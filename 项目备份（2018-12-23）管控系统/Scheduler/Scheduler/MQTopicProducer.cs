...
namespace Scheduler
{
    class MQTopicProducer
    {
        ...
        public MQTopicProducer(String ip, String sendMessage, String topicName)
        {
            try
            {
                ...
                destination = new ActiveMQTopic(topicName);//通过会话创建生产者，方法里面new出来的是MQ中的Topic
